...
<?php 
	...
	$URL = "https://localhost:44332/api/Mecanico";
...
<h5 class="col-xs-2 col-md-8 col-lg-13 display-1 text-center py-5 container"><center>Mecanicos</center></h5>
<div style="text-align: right;width:1900px">
 <a href="CRUD/FormularioMecanico.php">
...
<?php foreach ($characters as $character) : ?>
        <tr>
            ...
            <td> <?php echo $character->apellido; ?> </td>
            <td> <?php echo $character->dpi; ?> </td>
            <td> <?php echo $character->telefono; ?> </td>
            <td> <?php echo $character->especialidadId; ?> </td>
