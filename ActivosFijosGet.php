...
<?php 
	...
	$URL = "https://localhost:44332/api/ActivosFijos";
...
<h5 class="col-xs-2 col-md-8 col-lg-13 display-1 text-center py-5 container"><center>Activos Fijos</center></h5>
...
<thead align="center">
	<tr >
			<th>Id</th>
			<th>Descripcion</th>
			<th>Tipo Activos ID</th>
			<th>Cliente ID</th>
			<th>Orden de trabajo ID</th>
			<th>Agregar</th>
			<th>Editar</th>
			<th>Elimiar</th>
			<th>Reporte PDF</th>
...
<?php foreach ($characters as $character) : ?>
        <tr>
            ...
            <td> <?php echo $character->descripcion; ?> </td>
            <td> <?php echo $character->tipoActivosId; ?> </td>
            <td> <?php echo $character->clientesId; ?> </td>
            <td> <?php echo $character->ordenTrabajoId; ?> </td>
            <td>
