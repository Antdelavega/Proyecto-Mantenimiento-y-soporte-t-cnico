...
<?php 
	...
	$URL = "https://localhost:44332/api/Vehiculos";
...
<h5 class="col-xs-2 col-md-8 col-lg-13 display-1 text-center py-5 container"><center>Vehiculos/Otro Activo</center></h5>
...
<?php foreach ($characters as $character) : ?>
        <tr>
            ...
            <td> <?php echo $character->numeroPlaca; ?> </td>
            <td> <?php echo $character->descripcion; ?> </td>
            <td> <?php echo $character->numeroMotor; ?> </td>
            <td> <?php echo $character->tipoVehiculoId; ?> </td>
