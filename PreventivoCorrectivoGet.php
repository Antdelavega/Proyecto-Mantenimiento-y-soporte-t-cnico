...
<?php 
	...
	$URL = "https://localhost:44332/api/PreventivoCorrectivo";
...
<h5 class="col-xs-2 col-md-8 col-lg-13 display-1 text-center py-5 container"><center>Preventivo Correctivo </center></h5>
...
<?php foreach ($characters as $character) : ?>
        <tr>
            ...
            <td> <?php echo $character->defecto_observado; ?> </td>
            <td>
