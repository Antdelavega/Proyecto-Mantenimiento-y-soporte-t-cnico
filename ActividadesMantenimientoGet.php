...
<?php 
	...
	$URL = "https://localhost:44332/api/ActividadesMantenimiento";
...
<h5 class="col-xs-2 col-md-8 col-lg-13 display-1 text-center py-5 container"><center>Actividades Mantenimiento</center></h5>
...
<thead align="center">
	<tr >
			...
			<th>Detalles</th>
			<th>Costo</th>
			<th>Periodo Mantenimiento ID</th>
			<th>Agregar</th>
			<th>Editar</th>
			<th>Elimiar</th>
			<th>Reporte PDF</th>
...
<?php foreach ($characters as $character) : ?>
        <tr>
            ...
            <td> <?php echo $character->nombre; ?> </td>
            <td> <?php echo $character->detalle; ?> </td>
            <td> <?php echo $character->costo; ?> </td>
            <td> <?php echo $character->periodoMantenimientoId; ?> </td>
            <td>
