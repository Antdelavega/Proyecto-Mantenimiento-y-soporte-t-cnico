...
<?php 
	...
	$URL = "https://localhost:44332/api/TipoActivos";
...
<h5 class="col-xs-2 col-md-8 col-lg-13 display-1 text-center py-5 container"><center>Tipo de Activos</center></h5>
...
<?php foreach ($characters as $character) : ?>
        <tr>
            ...
            <td> <?php echo $character->vehiculosId; ?> </td>
