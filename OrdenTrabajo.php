...
<?php 
	...
	$URL = "https://localhost:44332/api/OrdenTrabajo";
...
<h5 class="col-xs-2 col-md-8 col-lg-13 display-1 text-center py-5 container"><center>Ordenes de trabajos</center></h5>
...
<thead align="center">
	<tr >
			...
			<th>Costo</th>
			<th>Preventivo Correctivo ID</th>
			<th>Mecanico ID</th>
			<th>Agregar</th>
			<th>Editar</th>
			<th>Elimiar</th>
...
<?php foreach ($characters as $character) : ?>
        <tr>
            ...
            <td> <?php echo $character->periodicidadEntrega; ?> </td>
            <td> <?php echo $character->costo; ?> </td>
            <td> <?php echo $character->preventivoCorrectivoId; ?> </td>
            <td> <?php echo $character->mecanicoId; ?> </td>
            <td>
